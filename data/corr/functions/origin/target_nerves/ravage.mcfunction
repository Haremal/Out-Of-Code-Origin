...
execute as @e[distance=..15,nbt={Brain:{}},tag=!NAN] at @s if predicate corr:true-false run tp @e[tag=RAVAGE,limit=1,sort=nearest] ^-4 ^2 ^ facing entity @s eyes
execute as @e[distance=..15,nbt={Brain:{}},tag=!NAN] at @s unless predicate corr:true-false run tp @e[tag=RAVAGE,limit=1,sort=nearest] ^4.5 ^1.5 ^ facing entity @s eyes
